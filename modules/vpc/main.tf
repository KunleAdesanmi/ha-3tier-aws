# This module creates a VPC with public and private subnets in two availability zones.
# It also creates an internet gateway and a route table for the public subnets.
